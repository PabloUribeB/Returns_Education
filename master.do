...
do "${do_files}\Step 5.1 - City estimations.do"
do "${do_files}\Step 5.2 - RIF regressions.do"
do "${do_files}\Step 6 - Main plots.do"
do "${do_files}\Step 6.1 - City plots.do"
do "${do_files}\Step 6.2 - RIF plots.do"